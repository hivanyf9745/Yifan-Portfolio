!(function (t, e) {
              ...
              value: function (t, e) {
                if (((e %= 360), (t %= 360) || e)) {
                  var n = this.m,
                    ...
                    o = n[2],
                    u = n[3];
                  t && ((t = j(t * B)), (n[2] += r * t), (n[3] += i * t)),
                    e && ((e = j(e * B)), (n[0] += o * e), (n[1] += u * e)),
                    (this.w = this.s = this.i = null);
                }
                return this;
              },
              ...
              value: function () {
                ...
                return (
                  i[1][1] < 0
                    ...
                    : (l = P(i[0][1]) * T),
                  u && (l = -l),
                  (a = M(a, I(i[0][0] * i[0][0] + i[0][1] * i[0][1])) * T),
                  u && (a = -a),
                  {
                    origin: { x: g(n[4]), y: g(n[5]) },
                    translate: { x: g(t), y: g(e) },
  ...
  function L(t, e, n) {
    return 0 === t ? e : 1 === t ? n : { x: F(t, e.x, n.x), y: F(t, e.y, n.y) };
  }
  function V(t, e, n) {
  ...
  function et(t, e, r, i, o) {
    var u,
      ...
      f = N;
    switch (
      (a ? ((u = r.substr(1)), (r = u.replace(H, Q))) : s && (r = r.substr(1)),
      n(l))
    ) {
      case "function":
    ...
    if (t && t.length) {
      ...
      return (
        ...
        (u = (function (t, e, n) {
          ...
          t = t.substring(4);
          for (var i = (e % r) + (n % 27), o = [], u = 0; u < t.length; u += 2)
            if ("|" !== t[u]) {
    ...
    function t(e, n, i) {
      ...
      var o = (function (t) {
        ...
        return (
          ...
          (o.el =
            Array.from(r.querySelectorAll("iframe,object")).filter(function (
              t
            ) {
          ...
          var n =
            ...
            o = function () {
              ...
              var h = t.getBoundingClientRect(),
                ...
                y = Math.min(h.height, Math.max(0, h.bottom - u)),
                d = Math.min(h.width, Math.max(0, a - h.left)),
                g = Math.min(h.width, Math.max(0, h.right - s)),
                p = (h.height - v - y) / h.height,
                m = (h.width - d - g) / h.width,
  ...
  function yt(t) {
    ...
    return t && t.length ? t.map(vt).join(e) : "";
  }
  function dt(t) {
    ...
    bt = {
      ...
      i: function (t, e, n) {
        return 0 === t
          ...
          : 1 === t
          ? n
          : { width: C(t, e.width, n.width), height: C(t, e.height, n.height) };
      },
      u: function (t, e) {
        return function (n) {
          var r = e(n);
          t.setAttribute("width", vt(r.width)),
            t.setAttribute("height", vt(r.height));
        };
      },
    };
  ...
  function Et(t, e, n) {
    var r = arguments.length > 3 && void 0 !== arguments[3] && arguments[3],
      i = { x: St(t.x, e.x, n), y: St(t.y, e.y, n) };
    return r && (i.a = Pt(t, e)), i;
  }
  function Pt(t, e) {
  ...
  function Nt(t, e, n, r, i) {
    var o = arguments.length > 5 && void 0 !== arguments[5] && arguments[5],
      u = Ot(t, e, n, r, i);
    return (
      u || (u = { x: It(t.x, e.x, n.x, r.x, i), y: It(t.y, e.y, n.y, r.y, i) }),
      o && (u.a = Ft(t, e, n, r, i)),
      u
    );
  }
  ...
  function Ct(t, e, n) {
    ...
    if (Lt(e)) {
      ...
      if (qt(e))
        return Vt(n) ? Nt(e, e.end, n.start, n, t, r) : Bt(e, e.end, n, t, r);
      if (Vt(n)) return Bt(e, n.start, n, t, r);
    }
    return Et(e, n, t, r);
  }
  ...
  var zt = {
    ...
    Yt = {
      ...
      u: function (t, e) {
        return function (n) {
          var r = e(n);
          t.setAttribute("x1", vt(r[0])),
            t.setAttribute("y1", vt(r[1])),
            t.setAttribute("x2", vt(r[2])),
            t.setAttribute("y2", vt(r[3]));
        };
      },
    },
    Ut = { f: vt, i: F },
          ...
          return (
            (function (t, e) {
              ...
              for (var o = 0, u = n.length, a = e.length - 1; o < u; o++)
                n[o].setAttribute("stop-color", gt(e[Math.min(o, a)].c)),
            ...
            Object.keys(Qt).forEach(function (t) {
              if (void 0 !== o[t])
                if ("object" !== n(Qt[t])) {
                  ...
                  Object.keys(Qt[t]).forEach(function (e) {
                    if (void 0 !== o[t][e]) {
                      var n = o[t][e],
                        r = Qt[t][e];
  ...
  function Jt(t, n, r) {
    ...
    if (n && r) {
      ...
      if (i === r.t)
        switch (n.t) {
          case "c":
            return { t: i, v: G(t, n.v, r.v) };
          case "g":
            if (n.r === r.r) {
              var o = { t: i, s: Kt(t, n.s, r.s), r: n.r };
              return (
                n.gt && r.gt && (o.gt = z(t, n.gt, r.gt)),
                n.c
                  ? ((o.c = L(t, n.c, r.c)), (o.rd = C(t, n.rd, r.rd)))
                  : n.f && ((o.f = L(t, n.f, r.f)), (o.to = L(t, n.to, r.to))),
                o
              );
            }
        }
  ...
  function Zt(t, e, n) {
    return { o: D(t, e.o, n.o || 0), c: G(t, e.c, n.c || {}) };
  }
  function te(t) {
  ...
  var re = {
    blur: function (t) {
      return t
        ? function (e) {
            t.setAttribute("stdDeviation", dt(e));
          }
        : null;
    },
      ...
      return o
        ? function (t) {
            r.setAttribute("stdDeviation", dt(t.blur)),
              i.setAttribute("dx", vt(t.offset.x)),
              i.setAttribute("dy", vt(t.offset.y)),
              o.setAttribute("flood-color", gt(t.color));
          }
        : null;
    },
          ...
          var n = (t = t.map(function (t) {
            return t && re[t[0]]
              ? (e.getElementById(t[1]),
                re[t[0]](e.getElementById(t[1]), t[1], e))
              : null;
          })).length;
          return function (e) {
          ...
          [
            ...
            },
            {
              ...
              value: function () {
                ...
                return t === he && this.trigger("play", this.offset), e;
              },
            },
            {
              key: "pause",
              value: function () {
                ...
                return (
                  e === he && this.trigger(t ? "end" : "pause", this.offset), n
                );
              },
            },
            {
            ...
            },
            {
              ...
              value: function () {
                ...
                return t === he && this.trigger("stop", this.offset), e;
              },
            },
            {
              key: "_apply",
    ...
    animations: [
      {
        elements: {
          e1lz5v4EZQa53: {
            transform: {
              data: { t: { x: -193.550003, y: -58.790001 } },
              keys: {
                o: [
                  {
                    t: 600,
                    v: { x: 183.550003, y: 48.785002, type: "corner" },
                  },
                  {
                    t: 1500,
                    v: { x: 193.550003, y: 58.785002, type: "corner" },
                  },
                ],
              },
            },
          ...
          e1lz5v4EZQa54: {
            transform: {
              data: { t: { x: -199.005005, y: -58.790001 } },
              keys: {
                o: [
                  {
                    t: 600,
                    v: { x: 209.005005, y: 48.785002, type: "corner" },
                  },
                  {
                    t: 1500,
                    v: { x: 199.005005, y: 58.790001, type: "corner" },
                  },
                ],
              },
            },
          ...
          e1lz5v4EZQa55: {
            transform: {
              data: { t: { x: -199.040001, y: -64.245001 } },
              keys: {
                o: [
                  {
                    t: 600,
                    v: { x: 209.040001, y: 74.240002, type: "corner" },
                  },
                  {
                    t: 1500,
                    v: { x: 199.040001, y: 64.245001, type: "corner" },
                  },
                ],
              },
            },
          ...
          e1lz5v4EZQa56: {
            transform: {
              data: { t: { x: -193.580002, y: -64.245001 } },
              keys: {
                o: [
                  {
                    t: 600,
                    v: { x: 183.580002, y: 74.240002, type: "corner" },
                  },
                  {
                    t: 1500,
                    v: { x: 193.580002, y: 64.245001, type: "corner" },
                  },
                ],
              },
            },
          ...
          e1lz5v4EZQa57: {
            transform: {
              data: { t: { x: -141.769997, y: -119.870003 } },
              keys: {
                o: [
                  {
                    t: 1600,
                    v: { x: 141.769997, y: 109.865004, type: "corner" },
                  },
                  {
                    t: 2400,
                    v: { x: 141.769997, y: 119.870003, type: "corner" },
                  },
                ],
              },
            },
          ...
          e1lz5v4EZQa58: {
            transform: {
              data: { t: { x: -265.380005, y: -57.135 } },
              keys: {
                o: [
                  { t: 600, v: { x: 255.380001, y: 57.135, type: "corner" } },
                  { t: 1500, v: { x: 265.380001, y: 57.135, type: "corner" } },
                ],
              },
            },
            opacity: [
          ...
          e1lz5v4EZQa66: {
            transform: {
              data: { t: { x: -26.725, y: -48.089998 } },
              keys: {
                o: [
                  { t: 600, v: { x: 26.725, y: 38.085001, type: "corner" } },
                  { t: 1500, v: { x: 26.725, y: 48.085001, type: "corner" } },
                ],
              },
            },
            opacity: [
          ...
          e1lz5v4EZQa73: {
            transform: {
              data: {
                o: { x: 46.100004, y: 65.635, type: "corner" },
                t: { x: -46.100004, y: -65.635 },
              },
              keys: {
                s: [
                  { t: 0, v: { x: 0, y: 0 } },
          ...
          e1lz5v4EZQa74: {
            transform: {
              data: {
                o: { x: 244.170021, y: 111.415001, type: "corner" },
                t: { x: -245.170021, y: -111.415001 },
              },
              keys: {
                s: [
                  { t: 300, v: { x: 0, y: 0 } },
          ...
          e1lz5v4EZQa75: {
            transform: {
              data: {
                o: { x: 216.594994, y: 58.015001, type: "corner" },
                t: { x: -216.594994, y: -58.015001 },
              },
              keys: {
                s: [
                  { t: 200, v: { x: 0, y: 0 } },
          ...
          e1lz5v4EZQa76: {
            transform: {
              data: {
                o: { x: 60.554998, y: 46.625002, type: "corner" },
                t: { x: -60.554998, y: -46.625002 },
              },
              keys: {
                s: [
                  { t: 100, v: { x: 0, y: 0 } },
          ...
          e1lz5v4EZQa77: {
            transform: {
              data: { t: { x: -211.849998, y: -121.010002 } },
              keys: {
                o: [
                  {
                    t: 600,
                    v: { x: 221.849996, y: 121.010002, type: "corner" },
                  },
                  {
                    t: 1500,
                    v: { x: 211.849996, y: 121.010002, type: "corner" },
                  },
                ],
              },
            },
          ...
          e1lz5v4EZQa86: {
            transform: {
              data: {
                o: { x: 116.549995, y: 98.939999, type: "corner" },
                t: { x: -116.549995, y: -98.939999 },
              },
              keys: {
                s: [
                  { t: 0, v: { x: 0, y: 0 } },
          ...
          e1lz5v4EZQa92: {
            transform: {
              data: { t: { x: -96.775002, y: -61.990002 } },
              keys: {
                o: [
                  { t: 600, v: { x: 86.775, y: 61.990002, type: "corner" } },
                  { t: 1500, v: { x: 96.775, y: 61.990002, type: "corner" } },
                ],
              },
            },
            opacity: [
          ...
          e1lz5v4EZQa111: {
            transform: {
              data: { t: { x: -250.559998, y: -63.530001 } },
              keys: {
                o: [
                  {
                    t: 600,
                    v: { x: 250.559998, y: 73.535001, type: "corner" },
                  },
                  {
                    t: 1500,
                    v: { x: 250.559998, y: 63.535001, type: "corner" },
                  },
                ],
              },
            },
          ...
          e1lz5v4EZQa122: {
            transform: {
              data: { t: { x: -51.559999, y: -98.98 } },
              keys: {
                o: [
                  {
                    t: 600,
                    v: { x: 51.559999, y: 108.975004, type: "corner" },
                  },
                  {
                    t: 1500,
                    v: { x: 51.559999, y: 98.975004, type: "corner" },
                  },
                ],
              },
            },
          ...
          e1lz5v4EZQa140: {
            transform: {
              data: { t: { x: -60.08, y: -127.420002 } },
              keys: {
                o: [
                  { t: 1600, v: { x: 70.08, y: 137.490002, type: "corner" } },
                  { t: 2400, v: { x: 60.08, y: 127.491697, type: "corner" } },
                ],
              },
            },
            opacity: [
          ...
          e1lz5v4EZQa141: {
            transform: {
              data: { t: { x: -78.480007, y: -127.430008 } },
              keys: {
                o: [
                  {
                    t: 1600,
                    v: { x: 88.480007, y: 117.430008, type: "corner" },
                  },
                  {
                    t: 2400,
                    v: { x: 78.480007, y: 127.430008, type: "corner" },
                  },
                ],
              },
            },
          ...
          e1lz5v4EZQa142: {
            transform: {
              data: { t: { x: -69.279999, y: -111.234997 } },
              keys: {
                o: [
                  {
                    t: 1600,
                    v: { x: 59.279999, y: 111.234997, type: "corner" },
                  },
                  {
                    t: 2400,
                    v: { x: 69.279999, y: 111.234997, type: "corner" },
                  },
                ],
              },
            },
          ...
          e1lz5v4EZQa143: {
            transform: {
              data: { t: { x: -75.669998, y: -111.460003 } },
              keys: {
                o: [
                  {
                    t: 1600,
                    v: { x: 65.669998, y: 111.460003, type: "corner" },
                  },
                  {
                    t: 2400,
                    v: { x: 75.669998, y: 111.460003, type: "corner" },
                  },
                ],
              },
            },
          ...
          e1lz5v4EZQa149: {
            transform: {
              data: { t: { x: -80.729992, y: -122.114998 } },
              keys: {
                o: [
                  { t: 1600, v: { x: 90.73, y: 112.11, type: "corner" } },
                  {
                    t: 2400,
                    v: { x: 80.729992, y: 122.114998, type: "corner" },
                  },
                ],
              },
            },
          ...
          e1lz5v4EZQa155: {
            transform: {
              data: { t: { x: -54.615002, y: -117.325005 } },
              keys: {
                o: [
                  {
                    t: 1600,
                    v: { x: 64.615001, y: 127.325005, type: "corner" },
                  },
                  {
                    t: 2400,
                    v: { x: 54.615002, y: 117.325005, type: "corner" },
                  },
                ],
              },
            },
          ...
          e1lz5v4EZQa176: {
            transform: {
              data: { t: { x: -141.219997, y: -108.305004 } },
              keys: {
                o: [
                  {
                    t: 1600,
                    v: { x: 141.219997, y: 98.305365, type: "corner" },
                  },
                  {
                    t: 2400,
                    v: { x: 141.219997, y: 108.305004, type: "corner" },
                  },
                ],
              },
            },
        ...
        s: "",
      },
    ],
    options: "MDLAxMDgyRTI5NL2E3YjY4Nzk3DYjI5NDEyOTcCzNzY2OEI2YjRI5ODQ/",
  },
  "__SVGATOR_PLAYER__",
  window,
  document
